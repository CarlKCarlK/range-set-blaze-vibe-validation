...
For measured refactoring work, use the repository's v3 metric collector and integrity checks. Use Sol for design and review, and Luna for bounded mechanical implementation and verification when Luna is available.
